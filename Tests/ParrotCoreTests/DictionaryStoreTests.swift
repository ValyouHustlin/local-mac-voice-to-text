...
struct DictionaryStoreTests {
    ...
    func rejectsEmptyAndDuplicateMatches() {
        let duplicateEntries = [
            DictionaryEntry(spokenForm: "Parrot", replacement: "one"),
            DictionaryEntry(spokenForm: "parrot", replacement: "two"),
        ]
        ...
        #expect(throws: DictionaryStoreError.duplicateSpokenForm("parrot")) {
